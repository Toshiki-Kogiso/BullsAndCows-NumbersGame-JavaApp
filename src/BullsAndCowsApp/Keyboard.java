 ...
 * CompSci 101 - BullsAndCowsApp.Keyboard Class
 * ============================
 ...
 * Example usage:
 *
 * String input = BullsAndCowsApp.Keyboard.readInput();
 *
...
public class Keyboard {
    ...
    public static String readInput() {
        ...
        try {
            ...
            System.err.println("An error has occurred in the BullsAndCowsApp.Keyboard constructor.");
            e.printStackTrace();
            System.exit(-1);
        }
        ...
        try {
            ...
            System.err.println("An error has occurred in the BullsAndCowsApp.Keyboard.readInput() method.");
            e.printStackTrace();
            System.exit(-1);
        }
        return null;
